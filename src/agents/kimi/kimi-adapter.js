...
export function createKimiAdapter({ permissionPolicy, log, client, clientOptions, ...options } = {}) {
  return createAcpAdapter({
    ...
    permissionPolicy,
    log,
    client: client ?? new KimiAcpClient({ permissionPolicy, onLog: log, ...clientOptions }),
    ...options
  });
}
